...
p "cross_sec_Emin0.100Emax3.200N019992h0.001000.dat" u 1:($2*3.57*3.57) w l lw 5 lc rgb "black" t '\small Numerical' , "toenniesexperimentaldata.txt" u 1:($2*scale) ps 1.5 pt 2 lc rgb "red" t '\small Experiment'
set output
